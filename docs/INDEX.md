...
|------|---------|---------|-------------|
| [ROADMAP.md](ROADMAP.md) | Vision, target audience, and phased MVP plan from current state to public launch | 2026-02-22 | 2026-02-23 |
...
| [implementation/web-scratchpad.md](implementation/web-scratchpad.md) | Working log for web app implementation sessions (includes deployment log) | — | 2026-02-15 | 2026-02-23 |
...
**Corpus:** 46,633 documents, 22 sites, 14,834 citation edges. Only 14.5% have body text — backfilling the rest is the top priority.

**Active sprint:** Sprint 1 — Subsidies Report + Full Corpus Infrastructure. Plan at `.claude/plans/validated-foraging-clover.md`. Body text backfill running in parallel; subsidy extraction pipeline, analysis scripts, and report page built. Awaiting backfill completion to run against expanded corpus and finalize report.
