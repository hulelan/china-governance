...
SITES = {
    ...
    "nbs": {
        ...
        "sections": ["/xw/tjxw/tzgg/", "/sj/zxfb/", "/xxgk/", "/gk/"],
    },
    "mva": {
    ...
    "shenyang": {
        ...
        "sections": ["/zwgk/zwdt/szfxx/zydt/", "/zwgk/zwdt/bmdt/", "/dwgk/"],
    },
    "shandong": {
    ...
    "natcm": {
        ...
        "sections": ["/a/zcwj/", "/a/tzgg/", "/a/zcjd/", "/xinxifabu/", "/zhengcewenjian/"],
    },
    "safe": {
    ...
    "liuzhou": {"name": "Liuzhou (柳州市)", "base_url": "http://www.liuzhou.gov.cn", "admin_level": "municipal", "group": "city", "sections": ["/", "/tyjrswj/", "/lzcyyq/"]},
    ...
    "sm": {"name": "三明市", "base_url": "https://www.sm.gov.cn", "admin_level": "municipal", "group": "city2", "sections": ["/", "/zcjd/"]},
    ...
    "yc": {"name": "伊春市", "base_url": "https://www.yc.gov.cn", "admin_level": "municipal", "group": "city2", "sections": ["/"]},
    "xjyl": {"name": "伊犁哈萨克自治州", "base_url": "https://www.xjyl.gov.cn", "admin_level": "municipal", "group": "city2", "sections": ["/"]},
    ...
    "panjin": {"name": "盘锦市", "base_url": "https://www.panjin.gov.cn", "admin_level": "municipal", "group": "city2", "sections": ["/"]},
    "shizuishan": {"name": "石嘴山市", "base_url": "https://www.shizuishan.gov.cn", "admin_level": "municipal", "group": "city2", "sections": ["/", "/szsgk/"]},
    ...
    "tonghua": {"name": "通化市", "base_url": "https://www.tonghua.gov.cn", "admin_level": "municipal", "group": "city2", "sections": ["/", "/ldzc/"]},
    "naqu": {"name": "那曲地区", "base_url": "https://www.naqu.gov.cn", "admin_level": "municipal", "group": "city2", "sections": ["/"]},
    "zhengzhou": {"name": "郑州市", "base_url": "https://www.zhengzhou.gov.cn", "admin_level": "municipal", "group": "city2", "sections": ["/"]},
    "tl": {"name": "铜陵市", "base_url": "https://www.tl.gov.cn", "admin_level": "municipal", "group": "city2", "sections": ["/"]},
    "xlgl": {"name": "锡林郭勒盟", "base_url": "https://www.xlgl.gov.cn", "admin_level": "municipal", "group": "city2", "sections": ["/"]},
    "changchun": {"name": "长春市", "base_url": "http://www.changchun.gov.cn", "admin_level": "municipal", "group": "city2", "sections": ["/"]},
    "fuxin": {"name": "阜新市", "base_url": "https://www.fuxin.gov.cn", "admin_level": "municipal", "group": "city2", "sections": ["/"]},
    "fuyang": {"name": "阜阳市", "base_url": "https://www.fuyang.gov.cn", "admin_level": "municipal", "group": "city2", "sections": ["/"]},
    ...
    "bjb_wjw": {"name": "Beijing Health Commission (北京市卫健委)", "base_url": "https://wjw.beijing.gov.cn", "admin_level": "municipal", "group": "dept", "sections": ["/zwgk_20040/zcwj2024/zcwjss/", "/zwgk_20040/zcwj2022/flfg/", "/zwgk_20040/tzgg/", "/wjwh/"]},
    ...
    "bjb_ybj": {"name": "Beijing Medical Insurance Bureau (北京市医保局)", "base_url": "https://ybj.beijing.gov.cn", "admin_level": "municipal", "group": "dept", "sections": ["/tzgg2022/", "/swdt/2020_gzdt/", "/zwgk/", "/zczxs/"]},
    ...
    "nx_fzggw": {"name": "Ningxia DRC (宁夏发改委)", "base_url": "https://fzggw.nx.gov.cn",
        "admin_level": "provincial", "group": "dept", "sections": ["/zcgh/zcjd/index.html", "/zcgh/fgwwj/index.html", "/zcgh/gfxwj1/index.html", "/tzgg/"]},
    ...
    "nx_zrzyt": {"name": "Ningxia Natural Resources Dept (宁夏自然资源厅)", "base_url": "https://zrzyt.nx.gov.cn",
        "admin_level": "provincial", "group": "dept", "sections": ["/gk/fdzdgknr/tzgg/index.html", "/gk/fdzdgknr/kczygl/index.html", "/xwdt/gzdt/index.html", "/ggbf/"]},
    ...
    "nx_jtt": {"name": "Ningxia Transport Dept (宁夏交通厅)", "base_url": "https://jtt.nx.gov.cn",
        "admin_level": "provincial", "group": "dept", "sections": ["/xwzx/tzgg/index.html", "/xwzx/jtyw/index.html", "/xwzx/zwdt/index.html", "/zfxxgk/"]},
    ...
    "nx_dofcom": {"name": "Ningxia Commerce Dept (宁夏商务厅)", "base_url": "https://dofcom.nx.gov.cn",
        "admin_level": "provincial", "group": "dept", "sections": ["/zwgk_274/fdzdgknr/hygk/index.html", "/zwgk_274/fdzdgknr/rsgk/index.html", "/zwgk_274/fdzdgknr/cwgk/index.html", "/zcfb/"]},
    ...
    "fj_qb": {"name": "福建侨网", "base_url": "https://qb.fujian.gov.cn",
        "admin_level": "provincial", "group": "dept", "sections": ["/xxgk/qwdt/sjdt/", "/xxgk/qwdt/jcdt/", "/jrfj/", "/qwjy/"]},
    ...
    "fj_scjgj": {"name": "福建省市场监督管理局(知识产权局)", "base_url": "https://scjgj.fujian.gov.cn",
        "admin_level": "provincial", "group": "dept", "sections": ["/zfxxgkzl/xxgkml/zcfg/gfxwj/", "/zw/tzgg/", "/zw/zcfg/flfggz/", "/zcjd/"]},
    ...
    "fj_sjt": {"name": "福建省审计厅", "base_url": "https://sjt.fujian.gov.cn",
        "admin_level": "provincial", "group": "dept", "sections": ["/zwgk/gsgg/tzgg/", "/zwgk/zcjd/", "/zwgk/gsgg/sjjggg/", "/sjgk/"]},
    ...
    "fj_sthjt": {"name": "福建省生态环境厅", "base_url": "https://sthjt.fujian.gov.cn",
        "admin_level": "provincial", "group": "dept", "sections": ["/zwgk/gsgg/", "/zwgk/flfg/", "/zwgk/sthjyw/stdt/", "/gkxx/"]},
    ...
    "fj_tyj": {"name": "福建省体育局", "base_url": "https://tyj.fujian.gov.cn",
        "admin_level": "provincial", "group": "dept", "sections": ["/zwgk/gsgg/", "/zwgk/zcfg/pfyd/", "/zwgk/zcjd/bmzcwjjd/", "/gkxx/"]},
    ...
    "fj_wb": {"name": "福建省人民政府外事办公室网站", "base_url": "https://wb.fujian.gov.cn",
        "admin_level": "provincial", "group": "dept", "sections": ["/zwgk/gsgg/tgl/", "/zwgk/gzdt/zwyw/", "/zwgk/rsxx/zkzp/", "/jggk/"]},
    "fj_wjw": {"name": "福建省卫生健康委员会", "base_url": "https://wjw.fujian.gov.cn",
        "admin_level": "provincial", "group": "dept", "sections": ["/xxgk/gsgg/tzgg/", "/xxgk/gsgg/sgs/sgsxzxk/", "/xxgk/fgwj/flfg/", "/jggk/"]},
    "fj_wlt": {"name": "福建省文化和旅游厅", "base_url": "https://wlt.fujian.gov.cn",
        "admin_level": "provincial", "group": "dept", "sections": ["/zwgk/zcfg/gfxwj/", "/zwgk/tzgg/gztz/", "/zwgk/tzgg/gggs/", "/jggk/"]},
    ...
    "fj_ybj": {"name": "福建省医疗保障局", "base_url": "https://ybj.fujian.gov.cn",
        "admin_level": "provincial", "group": "dept", "sections": ["/zwgk/zcjd/bmzcwjjd/", "/zwgk/zcfg/", "/zwgk/gsgg/", "/jggk/"]},
    ...
    "fj_zrzyt": {"name": "福建省自然资源厅", "base_url": "https://zrzyt.fujian.gov.cn",
        "admin_level": "provincial", "group": "dept", "sections": ["/zwgk/zcfg/flfg/", "/zwgk/gsgg/", "/zwgk/zcfg/szfwj/", "/jggk/"]},
    "fj_bb": {"name": "中共福建省委机构编制委员会办公室", "base_url": "https://bb.fujian.gov.cn",
        "admin_level": "provincial", "group": "dept", "sections": ["/tzgg/", "/ggqy/", "/jgbzgl/", "/xxgk/"]},
    "fj_czt": {"name": "福建省财政厅", "base_url": "https://czt.fujian.gov.cn",
        "admin_level": "provincial", "group": "dept", "sections": ["/zwgk/tzgg/", "/zwgk/zfxxgk/fdzdgknr/gfxwj/jjqy/", "/zwgk/czxw/", "/jggk/"]},
    ...
    "fj_gdb": {"name": "福建省国防动员办公室", "base_url": "https://gdb.fujian.gov.cn",
        "admin_level": "provincial", "group": "dept", "sections": ["/xxgk/rfgzdt/", "/xxgk/tzgs/", "/xxgk/xzxk/", "/gkxx/"]},
    ...
    "fj_gzw": {"name": "福建省人民政府国有资产监督管理委员会", "base_url": "https://gzw.fujian.gov.cn",
        "admin_level": "provincial", "group": "dept", "sections": ["/zwgk/gzdt/gzjg/zcfg/", "/zwgk/gzdt/szyw/", "/zwgk/gzdt/gzyw/fzsgzw/", "/zcjd/"]},
    ...
    "fj_jgswglj": {"name": "福建省机关事务管理局", "base_url": "https://jgswglj.fujian.gov.cn",
        "admin_level": "provincial", "group": "dept", "sections": ["/xwzx/ggjxw/", "/zwxx/gzdt/", "/zwxx/tpxw/ttxw/", "/jggk/"]},
    "fj_jtyst": {"name": "福建省交通运输厅", "base_url": "https://jtyst.fujian.gov.cn",
        "admin_level": "provincial", "group": "dept", "sections": ["/zwgk/tzgg/", "/zwgk/jtyw/mtsy/", "/zwgk/zfxxgkzl/zfxxgkml/jtjsgl/", "/fzgkj/", "/mzwgk/"]},
    "fj_jyt": {"name": "福建省教育厅", "base_url": "https://jyt.fujian.gov.cn",
        "admin_level": "provincial", "group": "dept", "sections": ["/xxgk/zcjd/bmzcwjjd/", "/xxgk/zcjd/qtzcwjjd/", "/xxgk/zfxxgkzl/zfxxgkml/zcwj/", "/gkxx/"]},
    ...
    "fj_lsj": {"name": "福建省粮食和物资储备局", "base_url": "https://lsj.fujian.gov.cn",
        "admin_level": "provincial", "group": "dept", "sections": ["/xxgk/gsgg/", "/xxgk/gzdt/sxdt/", "/xxgk/gzdt/sjdt/", "/jggk/"]},
    "fj_lyj": {"name": "福建省林业局", "base_url": "https://lyj.fujian.gov.cn",
        "admin_level": "provincial", "group": "dept", "sections": ["/zwgk/zcfg/flfg/", "/zwgk/gsgg/", "/zwgk/zcjd/bmzcwj/", "/gkxx/"]},
    ...
    "whd_qiaokou": {"name": "Wuhan Qiaokou District (武汉硚口区)", "base_url": "http://www.qiaokou.gov.cn",
        "admin_level": "district", "group": "dept", "sections": ["/xxgk/zc/zcfg/zfwj/", "/qkxw/tzgg/", "/qkgk/"]},
